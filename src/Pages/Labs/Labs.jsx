...
import LabDetails from '../../Components/LabDetails/LabDetails.jsx';
...
setShowLabSchedule (prevState => !prevState);
  ...
  return (
    <>
        ...
        <div className="header_container">
          <div className={`header ${isMobile ? 'mobile-header' : ''}`}>
            ...
            <div className="utilities-container">
              <ul className="desktop-menu utilities" style={{ marginLeft: '10%' }}>
                <li>
                  <button
                ...
                <li style={{ margin: '8px' }} className="pc-icon">
                  <DesktopDropdown />
                </li>
                <li style={{ margin: '8px' }} className = 'pc-icon'>
                  <CityDropdown />
      ...
      <Slider {...sliderSettings} style={{borderRadius:"25"}} className="banner_slider">
  {bannerData.map ((banner, index) => (
    <div key={index}>
      <div
        className="banner_container banner"
      >
        <div
          className="banner_img"
          style={{float: 'left'}}
        >
          <img src={banner.image} alt={`Header${index + 1}`}  className="banner-img" />
        </div>
        <div
