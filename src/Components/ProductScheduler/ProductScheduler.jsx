...
import '../LabSchedule/LabSchedule.css';
import './ProductSchedule.css'
...
const ProductScheduler = ({onClose}) => {
  ...
  return (
    <div className="scheduler-container">
      <Card
        ...
        style={{width: '630px', height: '475px',marginTop:"40px"}}
      >
        <span className="close-btn" onClick={closePopup}>&times;</span>
        <Card.Body>
            <h3 className='medicine_name'>Violin spray</h3>
          <DateSlider
            dateSlots={dateSlots}
